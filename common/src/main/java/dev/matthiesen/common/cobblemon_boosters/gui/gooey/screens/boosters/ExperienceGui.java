...
public class ExperienceGui extends BoostersGuiTemplate {
    ...
    public ExperienceGui(String boostType, ServerPlayer player, IBoost activeBoost, Queue<? extends IBoost> queuedBoosts, String noActiveBoost, String stopBoostMsg, String boostInfo, ModPermission startPermission, ModPermission stopPermission, ModPermission statusPermission, ModPermission queuePermission, Runnable startOnClick) {
